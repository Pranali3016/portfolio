...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const botKnowledge = [
    ...
    // 4. TIMELINE, EDUCATION & ROLES
    {
      ...
      response: "Pranali's career timeline:<br><br>1. <strong>Python Developer (Jun 2025–Present) — Leometric Technology Pvt Ltd:</strong> Designing &amp; developing secure RESTful backend APIs using Python &amp; FastAPI, JWT/Google OAuth authentication, RBAC permissions, PostgreSQL/MySQL database modeling, Postman API testing, and Git/GitLab/GitHub workflows.<br><br>2. <strong>Python Developer Intern (Dec 2024–May 2025) — Leometric Technology Pvt Ltd:</strong> Engineered modular Python backend scripts, REST API endpoints, EDA, feature selection, data cleaning, and ML data prep pipelines."
    },
    {
      keywords: ['internship', 'leometric', 'leometric technology', 'intern', 'first role', 'python intern'],
      response: "Pranali's professional role &amp; internship experience:<br><br>&bull; <strong>Python Developer — Leometric Technology Pvt Ltd (Jun 2025–Present):</strong> Designing secure RESTful backend APIs with Python &amp; FastAPI, JWT/OAuth, RBAC permissions, PostgreSQL/MySQL database schemas, Postman, and Git/GitLab/GitHub.<br><br>&bull; <strong>Python Developer Intern — Leometric Technology Pvt Ltd (Dec 2024–May 2025):</strong> Engineered modular Python scripts, REST APIs, EDA, feature selection, and data cleaning with Pandas &amp; NumPy."
    },
    {
      ...
      response: "Pranali's professional experience includes:<br><br>&bull; <strong>Python Developer — Leometric Technology Pvt Ltd</strong> (Jun 2025 – Present): RESTful APIs, FastAPI, JWT/Google OAuth, RBAC, PostgreSQL/MySQL, Postman, Git/GitLab/GitHub.<br>&bull; <strong>Python Developer Intern — Leometric Technology Pvt Ltd</strong> (Dec 2024 – May 2025): Python REST APIs, EDA, Pandas/NumPy ML data pipelines, Git."
    },
    {
